...
function afterEachHandler(context) {
    ...
    if (remainingSteps.length > 0) {
        try {
            if (((_a = this.currentTest) === null || _a === void 0 ? void 0 : _a.state) === "failed") {
                ...
                if (constants_1.HOOK_FAILURE_EXPR.test(message)) {
                    return;
                }
                ...
                const failedTestStepFinished = wasUndefinedStepDefinition
                    ...
                    : {
                        ...
                        testStepResult: Object.assign(Object.assign({}, (message.includes("Multiple matching step definitions for")
                            ? {
                                status: messages_enums_1.TestStepResultStatus.AMBIGUOUS,
                                message,
                            }
                            : {
                                status: messages_enums_1.TestStepResultStatus.FAILED,
                ...
                if (wasUndefinedStepDefinition) {
                     ...
                     */
                    this.currentTest._retries = (_f = this.currentTest) === null || _f === void 0 ? void 0 : _f._currentRetry;
                }
                taskTestStepFinished(context, failedTestStepFinished);
                for (const skippedStep of remainingSteps) {
                    const hookIdOrPickleStepId = (0, assertions_1.ensure)((_h = (_g = skippedStep.hook) === null || _g === void 0 ? void 0 : _g.id) !== null && _h !== void 0 ? _h : (_j = skippedStep.pickleStep) === null || _j === void 0 ? void 0 : _j.id, "Expected a step to either be a hook or a pickleStep");
                    const testStepId = getTestStepId({
                        context,
                        pickleId: pickle.id,
                        hookIdOrPickleStepId,
                ...
                if (currentStepStartedAt) {
                    ...
                    const hookIdOrPickleStepId = (0, assertions_1.ensure)((_m = (_l = skippedStep.hook) === null || _l === void 0 ? void 0 : _l.id) !== null && _m !== void 0 ? _m : (_o = skippedStep.pickleStep) === null || _o === void 0 ? void 0 : _o.id, "Expected a step to either be a hook or a pickleStep");
                    const testStepId = getTestStepId({
                        context,
                        pickleId: pickle.id,
                        hookIdOrPickleStepId,
                ...
                for (const remainingStep of remainingSteps) {
                    const hookIdOrPickleStepId = (0, assertions_1.ensure)((_q = (_p = remainingStep.hook) === null || _p === void 0 ? void 0 : _p.id) !== null && _q !== void 0 ? _q : (_r = remainingStep.pickleStep) === null || _r === void 0 ? void 0 : _r.id, "Expected a step to either be a hook or a pickleStep");
                    const testStepId = getTestStepId({
                        context,
                        pickleId: pickle.id,
                        hookIdOrPickleStepId,
                ...
                for (const remainingStep of remainingSteps) {
                    const hookIdOrPickleStepId = (0, assertions_1.ensure)((_t = (_s = remainingStep.hook) === null || _s === void 0 ? void 0 : _s.id) !== null && _t !== void 0 ? _t : (_u = remainingStep.pickleStep) === null || _u === void 0 ? void 0 : _u.id, "Expected a step to either be a hook or a pickleStep");
                    const testStepId = getTestStepId({
                        context,
                        pickleId: pickle.id,
                        hookIdOrPickleStepId,
    ...
    const currentRetry = (0, assertions_1.ensure)((_v = this.currentTest) === null || _v === void 0 ? void 0 : _v._currentRetry, "Expected to find an attribute _currentRetry");
    const retries = (0, assertions_1.ensure)((_w = this.currentTest) === null || _w === void 0 ? void 0 : _w._retries, "Expected to find an attribute _retries");
        ...
        specEnvelopes.push({
            hook: {
                ...
                type: hook.keyword === "Before"
                    ? messages_enums_1.HookType.BEFORE_TEST_CASE
                    : messages_enums_1.HookType.AFTER_TEST_CASE,
            },
        });
    }
...
function createMissingStepDefinitionMessage(context, pickleStep, parameterTypeRegistry) {
  ...
  `;
    ...
    const snippets = new cucumber_expressions_1.CucumberExpressionGenerator(() => parameterTypeRegistry.parameterTypes)
        ...
        .map((expression) => (0, snippets_1.generateSnippet)(expression, (0, assertions_1.ensure)(pickleStep.type, "Expected pickleStep to have a type"), parameter))
